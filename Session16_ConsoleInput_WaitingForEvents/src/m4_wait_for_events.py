...
Authors: David Mutchler, Valerie Galluzzi, Mark Hays, Amanda Stouder,
         their colleagues and ussein Alawami.  October 2016.
...
def next_prime(m):
    ...
    while True:
        if is_prime(m):
            return m  # This also works because the return ends the
                    # function call, it does the same as break then return
        m += 1
...
def test_wait_for_sum_of_cubes():
    ...
    # Test 7:
    # done 6 (continued): PUT YOUR TEST(S) ** IN THE SPACE BETWEEN **
    #                   THE FOLLOWING LINES:
