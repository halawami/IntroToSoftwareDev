...
def test_count_cosines_from():
    ...
    # Test 2:
    expected = 2
    answer = count_cosines_from(5, 6, 0.27)
    ...
    # Test 4:
    expected = 0
    answer = count_cosines_from(9, 10, 0)
    print('Test 4 expected:', expected)
    print('       actual:  ', answer)

    # Test 5:
    expected = 2
    answer = count_cosines_from(0, 5, 0.29)
    print('Test 5 expected:', expected)
    print('       actual:  ', answer)

    # Test 6:
    expected = 2
    answer = count_cosines_from(0, 9, 0.9)
    print('Test 6 expected:', expected)
    print('       actual:  ', answer)

    # Test 7:
    expected = 0
    answer = count_cosines_from(1, 2, 12)
...
def test_sum_unit_fractions_from():
    ...
    # Test 2:
    expected = 2.3484  # This is APPROXIMATELY the correct answer.
    answer = sum_unit_fractions_from(10, 99)
    ...
    # Test 4:
    expected = 0.6345  # This is APPROXIMATELY the correct answer.
