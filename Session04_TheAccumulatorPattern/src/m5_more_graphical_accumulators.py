...
Authors: David Mutchler, Dave Fisher, Valerie Galluzzi, Amanda Stouder,
         their colleagues and Hussein Alawami.  March 2016.
...
def test_draw_circles_from_rectangle():
    ...
    title = "Draw circle from rectangle"
    window1 = rg.RoseWindow(400, 400, title)

    # Test 1
    rectangle11 = rg.Rectangle(rg.Point(100, 100), rg.Point(150, 150))
    rectangle11.fill_color = "blue"
    draw_circles_from_rectangle(2, 5, rectangle11, window1)

    # Test 2
    rectangle1 = rg.Rectangle(rg.Point(200, 200), rg.Point(300, 300))
    rectangle1.fill_color = "Red"
    draw_circles_from_rectangle(4, 5, rectangle1, window1)

    window2 = rg.RoseWindow(600, 600, title)
    # Test 3
    rectangle2 = rg.Rectangle(rg.Point(150, 150), rg.Point(245, 245))
    rectangle2.fill_color = "gold"
    draw_circles_from_rectangle(1, 11, rectangle2, window2)
...
def draw_circles_from_rectangle(m, n, rectangle, window):
    ...
    for k in range(m):
        ...
        circle.attach_to(window)
    window.render(0.05)
    radius1 = (rectangle.corner_2.x - rectangle.corner_1.x) / 2
    center1 = rg.Point((rectangle.corner_1.x + radius1), rectangle.corner_1.y - radius1)
    for r in range(n):
...
def draw_lines_from_rectangles(rectangle1, rectangle2, n, window):
    ...
    start = rg.Point(rectangle1.corner_1.x + ((rectangle1.corner_2.x - rectangle1.corner_1.x) / 2), rectangle1.corner_1.y + ((rectangle1.corner_2.y - rectangle1.corner_1.y) / 2))
    end = rg.Point(rectangle2.corner_1.x + ((rectangle2.corner_2.x - rectangle2.corner_1.x) / 2), rectangle2.corner_1.y + (((rectangle2.corner_2.y - rectangle2.corner_1.y) / 2)))
    changeX = abs(rectangle1.corner_2.x - rectangle1.corner_1.x)
    changeY = abs(rectangle1.corner_2.y - rectangle1.corner_1.y)
    for k in range(n):
