...
def rectangles_from_circles(circles):
    ...
    for k in range(len(circles)):
        start = rg.Point(circles[k].center.x - circles[k].radius, circles[k].center.y - circles[k].radius)
        end = rg.Point(circles[k].center.x + circles[k].radius, circles[k].center.y + circles[k].radius)
        list += [rg.Rectangle(start, end)]
    return list
