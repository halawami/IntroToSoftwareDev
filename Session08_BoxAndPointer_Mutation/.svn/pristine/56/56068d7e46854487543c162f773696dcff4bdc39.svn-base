...
def main():
    ...
    # print before: point(45,100) and after: (45,33)
    # ------------------------------------------------------------------
    ...
    mutate_point(point)
    print('After: ', point)  # To see that the INSIDES of   point   has changed
    # prints before: point(45,33) and after: point(45,77)
    # ------------------------------------------------------------------
    ...
    # prints before: point(45,77), point2(45,77) and after: point(100,77), point2(100,77)
    # ------------------------------------------------------------------
    ...
    # prints before: point(45,77), point2(100,77) and after: point(10,6), point(100,77)
    # ------------------------------------------------------------------
    ...
    # Before: point3 and point4 are: (100,20) and point4(100,20). T and T
    ...
    print('T or F: point3 is point4?', point3 is point4)
    print('T or F: point3 == point4?', point3 == point4)
    # After: point3 and point4 are: (100,20) and point4(100,20). fillcolors are blue,  T and T
    print()
    ...
    # point3 and point4 are: point3(100,20) and point4(100,20) and point5(100,20). fill colors are blue, T and T and T
    print()
