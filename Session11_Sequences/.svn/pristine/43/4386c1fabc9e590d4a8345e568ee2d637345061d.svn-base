...
Authors: David Mutchler, Valerie Galluzzi, Mark Hays, Amanda Stouder,
         their colleagues and Hussein Alawami.  January 2015.
...
def test_count_negative():
    ...
    # Test 5:
    expected = 0
    actual = count_negative([3, 2.5, 3, 55, 66, 100])
    print()
    print('Expected:', expected)
    print('Actual:  ', actual)
    ...
    # Test 6:
    expected = 2
    actual = count_negative([23, -500, 11, -0.0000001])
    print()
    print('Expected:', expected)
    print('Actual:  ', actual)
