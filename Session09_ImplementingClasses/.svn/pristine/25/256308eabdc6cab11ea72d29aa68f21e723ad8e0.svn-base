# Try to redo all of this after, it was challenging!
...
class Point(object):
    ...
    def move_to(self, x, y):
        ...
        self.y = y
        self.count += 1
        self.distance += math.sqrt((self.y - self.starty) ** 2 + (self.x - self.startx) ** 2)
        self.startx = x
        self.starty = y
    ...
    def get_distance_from_start(self):
        ...
        distance = math.sqrt((self.y - self.starty) ** 2 + (self.x - self.startx) ** 2)
        return distance
    ...
    def closer_to(self, p1, p2):
        distance1 = math.sqrt((self.y - p1.y) ** 2 + (self.x - p1.x) ** 2)
        distance2 = math.sqrt((self.y - p2.y) ** 2 + (self.x - p2.x) ** 2)
