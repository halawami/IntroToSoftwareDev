...
class CircleChanger(object):
    ...
    def __init__(self, x, y, radius, fill_color, colors):
        ...
        self.circle1 = rg.Circle(rg.Point(x, y), radius)
        self.circle1.fill_color = fill_color
    ...
    def distance_from(self, point):
        ...
        # this line is the same as defining this to a variable then returning it
    ...
    def swallow(self, other_circle_changer):
        ...
        diameter = rg.Line(self.circle.center, other_circle_changer.circle.center)
        centerx = diameter.get_midpoint().x
        centery = diameter.get_midpoint().y
        radius = self.distance_from(other_circle_changer.circle.center) * 1 / 2
        list = self.colors + other_circle_changer.colors
        circleChanger = CircleChanger(centerx, centery, radius, 'red', list)
    ...
    def change_to_original_color(self):
        ...
        self.circle.fill_color = self.circle1.fill_color
...
def test_distance_from():
    pass  # DCM needs to do this.
    # so we call it by saying object.method
    # the object in this case is cc
    # We write any point that we want to make it easier
    # when it calls the method, self will be cc and point will be point
    cc = CircleChanger(200, 150, 30, 'blue',
                       ('blue', 'yellow', 'green',
                                        'aquamarine', 'brown'))

    point = rg.Point(199, 149)
    print('actual: ' + str(cc.distance_from(point)))
    print('expected: ' + str(math.sqrt(2)))
