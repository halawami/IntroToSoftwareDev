...
def test_problem1b():
    ...
    print (" The expected value of Test 1 is = ", expected)
    print ("The actual values is = ", actual)

    # Test 2
    expected = 4
    actual = problem1b(3, 4)
    print (" The expected value of Test 2 is = ", expected)
    print ("The actual values is = ", actual)

    # Test 3
    expected = 3
    actual = problem1b(3, 3)
    print (" The expected value of Test 3 is = ", expected)
    print ("The actual values is = ", actual)

    # Test 4
    expected = 7
    actual = problem1b(3, 7)
    print (" The expected value of Test 4 is = ", expected)
    print ("The actual values is = ", actual)
