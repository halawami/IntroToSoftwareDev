...
def problem3b(m, point1):
    ...
    for k in range (m):
        point = rg.Point(point1.x, point1.y + 60)
        a = problem3a(window, point, 2 * k + 3)
        # This code draws the lines and takes the values of thickness and assigns
