...
Authors: David Mutchler, Valerie Galluzzi, Mark Hays, Amanda Stouder,
         their colleagues and Hussein Alawami.  October 2015.
...
def draw_wall_on_right(rectangle, n, window):
    ...
    distX = rectangle.get_upper_right_corner().x - rectangle.get_upper_left_corner().x
    distY = rectangle.get_lower_right_corner().y - rectangle.get_upper_right_corner().y
    ...
    for k in range(n):
        for _ in range(k + 1):
            rectangle1 = rg.Rectangle(upperLeft, lowerRight)
        ...
        lowerRight.y += distY
        upperLeft.y += distY
        upperLeft.x = rectangle.get_upper_left_corner().x
        lowerRight.x = rectangle.get_lower_right_corner().x
# ----------------------------------------------------------------------
