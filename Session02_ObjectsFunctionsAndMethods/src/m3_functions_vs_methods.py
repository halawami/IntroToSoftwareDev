...
#            The main function creates and closes a window and calls three functions to test them.
#
...
#            Creates a simple turtle and moves the cursor to x1,y1 and draws it to x2,y2
#
#     c. Read the green DOC-STRINGs of the   draw_many_squares
#        function below.  Summarize here, in 10 words or fewer,
#        what does  DRAW_MANY_SQUARES  do?
#            Draws many triangles with the twist specified by the user
#
#     d. Read the green DOC-STRINGs of the   turtle3
#        function below.  Summarize here, in 10 words or fewer,
#        what does  TURTLE3  do?
#            draws a line then circle and fills that circle
#
...
def try_methods():
    ...
    methodt = rg.SimpleTurtle()
    methodt.pen = rg.Pen('brown', 5)
    methodt.forward(150)
    methodt.left(90)
    methodt.forward(50)
    methodt.backward(100)
    ####################################################################
