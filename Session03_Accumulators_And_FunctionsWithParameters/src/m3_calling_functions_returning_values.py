...
Authors: David Mutchler, Valerie Galluzzi, Mark Hays, Amanda Stouder,
         their colleagues and Hussein Alawami.  December 2015.
...
def test_digits_in_cube():
    ...
    print("Test 2 expected = 10")
    print("Actual = ", answer)

    # Test 3
    answer = digits_in_cube(3)
    print("Test 3 expected = 9")
    print("Actual = ", answer)
...
def fancy_sums_of_digits(n):
    ...
    mx = sum_of_digits(n ** 1000)
    my = sum_of_digits(n ** 999)
    ans = mx ** my
    anss = sum_of_digits(ans)
    return anss
